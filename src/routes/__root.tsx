  ...
  head: () => ({
    meta: [
      ...
      { title: "Frame It LA — Luxury Photo Booth Rentals in Los Angeles" },
      {
        name: "description",
        content:
          "Frame It LA delivers premium photo booth experiences for weddings, corporate events, birthdays and brand activations across Los Angeles.",
      },
      { property: "og:title", content: "Frame It LA — Luxury Photo Booth Rentals" },
      { property: "og:description", content: "Premium photo booth experiences for every occasion." },
