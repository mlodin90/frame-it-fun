...
export default function ContactPage() {
  useDocumentMeta({
    ...
    description: "Get in touch with Frame It LA to book a premium photo booth for your wedding, corporate event, or celebration in Los Angeles.",
  });
        ...
        <div className="max-w-6xl mx-auto grid lg:grid-cols-5 gap-10">
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="mt-10 p-6 rounded-2xl border border-primary/30 bg-card/40">
              <div className="text-xs uppercase tracking-[0.3em] text-primary mb-2">Limited Offer</div>
